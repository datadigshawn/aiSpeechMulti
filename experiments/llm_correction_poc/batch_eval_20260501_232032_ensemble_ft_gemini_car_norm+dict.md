...
|---|---|---|---|---|
| control | 19 | 37.18% | 36.68% | +0.50% |
| daily | 26 | 26.83% | 25.26% | +1.57% |
| door | 4 | 40.87% | 40.16% | +0.72% |
| emergency | 1 | 5.48% | 5.48% | +0.00% |
| track | 4 | 25.30% | 23.54% | +1.75% |
...
| 022 | control | 28.89% | 26.22% | +2.67% | car_norm=1, number_norm=6, dict=2 |
...
| 026 | daily | 14.29% | 11.90% | +2.38% | car_norm=1, number_norm=2 |
...
| 032 | control | 24.05% | 22.15% | +1.90% | car_norm=4, number_norm=5 |
...
| 045 | door | 73.43% | 73.43% | +0.00% | dict=1 |
...
| 053 | daily | 17.89% | 17.89% | +0.00% | car_norm=1, number_norm=2, dict=2 |
| 054 | control | 36.53% | 35.62% | +0.91% | car_norm=2, number_norm=5, dict=3 |
| 055 | daily | 34.00% | 30.00% | +4.00% | car_norm=1, number_norm=2, dict=1 |
| 056 | daily | 20.83% | 18.06% | +2.78% | car_norm=2, number_norm=1, dict=3 |
| 057 | daily | 16.85% | 16.85% | +0.00% | car_norm=2, number_norm=2, dict=2 |
