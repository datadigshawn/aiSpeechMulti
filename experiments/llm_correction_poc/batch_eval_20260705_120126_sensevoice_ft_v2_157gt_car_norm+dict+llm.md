...
|---|---|---|---|---|
| control | 5 | 29.62% | 28.66% | +0.96% |
| daily | 8 | 27.94% | 27.67% | +0.27% |
| door | 3 | 22.58% | 21.75% | +0.83% |
| emergency | 1 | 21.74% | 18.01% | +3.73% |
| track | 2 | 18.40% | 16.90% | +1.49% |
...
| 002 | daily | 31.58% | 36.84% | -5.26% | number_norm=2, llm=1 |
...
| 018 | daily | 14.29% | 16.67% | -2.38% | number_norm=3, station_code=2, llm=3 |
...
| 033 | control | 28.97% | 28.10% | +0.86% | car_norm=1, number_norm=11, dict=1, station_code=2, llm=21 |
...
| 043 | daily | 30.88% | 29.41% | +1.47% | number_norm=1, llm=4 |
| 044 | control | 34.76% | 30.00% | +4.76% | car_norm=1, number_norm=6, dict=3, station_code=2, llm=8 |
| 045 | door | — | — | — | ❌ STT cache not found |
| 046 | control | — | — | — | ❌ STT cache not found |
| 047 | control | — | — | — | ❌ STT cache not found |
| 048 | daily | 28.00% | 28.00% | +0.00% | dict=1, llm=2 |
| 049 | daily | — | — | — | ❌ STT cache not found |
| 050 | control | — | — | — | ❌ STT cache not found |
| 051 | daily | 16.67% | 8.33% | +8.33% | car_norm=1, number_norm=1, station_code=1, llm=1 |
...
| G0001 | emergency | 21.74% | 18.01% | +3.73% | llm=10 |
...
| G0011 | door | 30.00% | 30.00% | +0.00% | car_norm=1, dict=1, llm=1 |
...
| G0029 | track | 12.50% | 10.94% | +1.56% | dict=2, llm=2 |
...
| G0042 | control | 44.19% | 44.01% | +0.19% | number_norm=7, dict=1, llm=11 |
...
| G0052 | daily | 43.75% | 43.75% | +0.00% | number_norm=1, llm=1 |
...
| G0063 | control | 21.65% | 22.68% | -1.03% | number_norm=1, llm=10 |
| G0064 | track | — | — | — | ❌ STT cache not found |
| G0065 | door | — | — | — | ❌ STT cache not found |
| G0066 | door | 15.79% | 14.74% | +1.05% | dict=2, llm=8 |
| G0067 | door | — | — | — | ❌ STT cache not found |
| G0068 | door | 21.94% | 20.50% | +1.44% | car_norm=2, number_norm=6, dict=2, llm=5 |
| G0069 | track | 24.29% | 22.86% | +1.43% | dict=2, llm=2 |
