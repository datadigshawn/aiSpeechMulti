...
|---|---|---|---|---|
| control | 18 | 39.72% | 37.67% | +2.05% |
| daily | 27 | 56.09% | 55.77% | +0.32% |
...
| 015 | daily | 65.79% | 65.79% | +0.00% | term_blacklist=1, car_norm=1 |
| 016 | daily | 71.05% | 71.05% | +0.00% | number_norm=1 |
| 017 | daily | 55.41% | 55.41% | +0.00% | — |
| 018 | daily | 42.86% | 42.86% | +0.00% | number_norm=3 |
| 019 | daily | 52.86% | 50.00% | +2.86% | car_norm=1, number_norm=2 |
| 020 | daily | 87.50% | 87.50% | +0.00% | — |
| 021 | control | 44.62% | 44.62% | +0.00% | number_norm=2 |
| 022 | control | 23.56% | 20.89% | +2.67% | number_norm=7, dict=1 |
| 023 | control | 40.00% | 40.00% | +0.00% | number_norm=1 |
| 024 | daily | 47.50% | 47.50% | +0.00% | — |
| 025 | daily | 53.12% | 53.12% | +0.00% | number_norm=1 |
| 026 | daily | 45.24% | 42.86% | +2.38% | car_norm=1, number_norm=1 |
| 027 | control | 6.12% | 4.08% | +2.04% | car_norm=1, number_norm=1 |
| 028 | control | 70.77% | 70.77% | +0.00% | number_norm=2 |
| 029 | control | 39.32% | 38.90% | +0.42% | car_norm=5, number_norm=5 |
| 030 | control | 37.55% | 37.55% | +0.00% | number_norm=5 |
| 031 | daily | 52.94% | 52.94% | +0.00% | — |
| 032 | control | 38.61% | 36.08% | +2.53% | car_norm=3, number_norm=3 |
| 033 | control | 34.83% | 34.66% | +0.17% | car_norm=1, number_norm=9 |
| 034 | door | 25.00% | 25.00% | +0.00% | number_norm=2 |
| 035 | control | 50.38% | 49.23% | +1.15% | car_norm=3 |
...
| 041 | control | 64.18% | 58.21% | +5.97% | car_norm=2, number_norm=1 |
| 042 | control | — | — | — | ❌ STT cache not found |
| 043 | daily | 58.82% | 57.35% | +1.47% | number_norm=1 |
| 044 | control | 27.14% | 24.76% | +2.38% | car_norm=1, number_norm=4, dict=4 |
| 045 | door | 51.57% | 51.57% | +0.00% | number_norm=12, dict=3 |
| 046 | control | 61.76% | 61.76% | +0.00% | — |
| 047 | control | 45.91% | 45.28% | +0.63% | number_norm=5, dict=1 |
| 048 | daily | 44.00% | 44.00% | +0.00% | dict=1 |
| 049 | daily | — | — | — | ❌ STT cache not found |
| 050 | control | 33.61% | 15.55% | +18.07% | term_blacklist=2, car_norm=2, number_norm=5, dict=1 |
| 051 | daily | 44.44% | 41.67% | +2.78% | car_norm=1 |
| 052 | daily | 49.07% | 50.93% | -1.86% | number_norm=5 |
| 053 | daily | 47.37% | 47.37% | +0.00% | number_norm=2, dict=1 |
| 054 | control | 38.81% | 37.90% | +0.91% | car_norm=2, number_norm=5 |
| 055 | daily | 56.00% | 56.00% | +0.00% | number_norm=1 |
| 056 | daily | 33.33% | 31.94% | +1.39% | car_norm=1, number_norm=1, dict=1 |
| 057 | daily | 29.21% | 29.21% | +0.00% | dict=1 |
