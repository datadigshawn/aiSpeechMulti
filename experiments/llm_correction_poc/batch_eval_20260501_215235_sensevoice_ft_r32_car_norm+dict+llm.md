...
|---|---|---|---|---|
| control | 3 | 34.35% | 33.99% | +0.36% |
| daily | 4 | 25.65% | 21.69% | +3.96% |
...
| 022 | control | 27.11% | 26.22% | +0.89% | car_norm=2, number_norm=4, dict=3, llm=11 |
...
| 033 | control | 43.62% | 41.90% | +1.72% | car_norm=1, number_norm=13, llm=7 |
