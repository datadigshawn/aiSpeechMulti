...
|---|---|---|---|---|
| control | 5 | 29.62% | 28.77% | +0.85% |
| daily | 8 | 27.94% | 27.07% | +0.86% |
| door | 3 | 22.58% | 21.75% | +0.83% |
| emergency | 1 | 21.74% | 17.39% | +4.35% |
| track | 2 | 18.40% | 18.32% | +0.06% |
...
| 018 | daily | 14.29% | 11.90% | +2.38% | number_norm=3, station_code=2, llm=3 |
...
| 033 | control | 28.97% | 28.28% | +0.69% | car_norm=1, number_norm=11, dict=1, station_code=2, llm=17 |
...
| 043 | daily | 30.88% | 29.41% | +1.47% | number_norm=1, llm=5 |
| 044 | control | 34.76% | 30.00% | +4.76% | car_norm=1, number_norm=6, dict=3, station_code=2, llm=7 |
| 045 | door | — | — | — | ❌ STT cache not found |
| 046 | control | — | — | — | ❌ STT cache not found |
| 047 | control | — | — | — | ❌ STT cache not found |
| 048 | daily | 28.00% | 28.00% | +0.00% | dict=1, llm=1 |
...
| G0001 | emergency | 21.74% | 17.39% | +4.35% | llm=11 |
...
| G0033 | daily | 33.33% | 33.33% | +0.00% | car_norm=1, llm=1 |
| G0034 | control | 18.52% | 18.52% | +0.00% | llm=1 |
...
| G0042 | control | 44.19% | 44.38% | -0.19% | number_norm=7, dict=1, llm=11 |
...
| G0068 | door | 21.94% | 20.50% | +1.44% | car_norm=2, number_norm=6, dict=2, llm=9 |
| G0069 | track | 24.29% | 25.71% | -1.43% | dict=2, llm=5 |
