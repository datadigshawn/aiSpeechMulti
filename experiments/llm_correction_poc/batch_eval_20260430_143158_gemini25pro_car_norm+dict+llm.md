...
|---|---|---|---|---|
| control | 19 | 38.08% | 35.02% | +3.06% |
| daily | 26 | 59.64% | 60.08% | -0.45% |
| door | 4 | 35.28% | 35.18% | +0.10% |
| emergency | 1 | 38.36% | 38.36% | +0.00% |
| track | 4 | 41.31% | 40.15% | +1.16% |
...
| 004 | track | 45.22% | 45.22% | +0.00% | term_blacklist=1, number_norm=6, llm=3 |
| 005 | daily | 69.05% | 90.48% | -21.43% | term_blacklist=1 |
| 006 | door | 42.86% | 42.86% | +0.00% | number_norm=2, llm=1 |
| 007 | train | 95.00% | 95.00% | +0.00% | — |
| 008 | track | — | — | — | ❌ STT cache not found |
| 009 | daily | 42.86% | 42.86% | +0.00% | number_norm=1 |
| 010 | control | 31.75% | 28.57% | +3.17% | number_norm=7, llm=2 |
| 011 | control | 25.00% | 24.14% | +0.86% | car_norm=3, number_norm=1, llm=1 |
| 012 | emergency | 38.36% | 38.36% | +0.00% | number_norm=2 |
| 013 | track | 34.52% | 32.14% | +2.38% | term_blacklist=1, llm=2 |
| 014 | track | 43.82% | 41.57% | +2.25% | number_norm=4, llm=2 |
| 015 | daily | 76.32% | 76.32% | +0.00% | — |
| 016 | daily | 78.95% | 78.95% | +0.00% | — |
| 017 | daily | 56.76% | 59.46% | -2.70% | number_norm=2, llm=2 |
| 018 | daily | 42.86% | 41.67% | +1.19% | number_norm=3, llm=1 |
| 019 | daily | 60.00% | 60.00% | +0.00% | number_norm=2 |
| 020 | daily | 81.25% | 81.25% | +0.00% | — |
| 021 | control | 44.62% | 36.15% | +8.46% | term_blacklist=1, car_norm=1, number_norm=2, llm=1 |
| 022 | control | 21.78% | 19.11% | +2.67% | number_norm=6, dict=2 |
| 023 | control | 37.60% | 32.80% | +4.80% | term_blacklist=1, number_norm=1, llm=2 |
| 024 | daily | — | — | — | ❌ STT cache not found |
| 025 | daily | 53.12% | 53.12% | +0.00% | number_norm=1 |
| 026 | daily | 50.00% | 47.62% | +2.38% | car_norm=1, number_norm=1, llm=1 |
| 027 | control | 8.16% | 6.12% | +2.04% | number_norm=1, llm=1 |
| 028 | control | 64.62% | 58.46% | +6.15% | car_norm=2, number_norm=2, llm=2 |
| 029 | control | 27.91% | 27.27% | +0.63% | car_norm=3, number_norm=4, llm=2 |
| 030 | control | 42.04% | 42.04% | +0.00% | car_norm=1, number_norm=5 |
| 031 | daily | 55.88% | 55.88% | +0.00% | llm=1 |
...
| 035 | control | 56.92% | 56.92% | +0.00% | dict=1, llm=2 |
...
| 040 | control | 44.75% | 41.55% | +3.20% | number_norm=1, llm=10 |
| 041 | control | — | — | — | ❌ STT cache not found |
| 042 | control | — | — | — | ❌ STT cache not found |
| 043 | daily | 63.24% | 63.24% | +0.00% | llm=1 |
| 044 | control | 30.95% | 29.52% | +1.43% | car_norm=2, number_norm=4, dict=3, llm=5 |
| 045 | door | 36.02% | 35.63% | +0.39% | dict=1, llm=1 |
...
| 052 | daily | 54.66% | 53.42% | +1.24% | number_norm=1, llm=1 |
...
| 058 | daily | 53.57% | 50.00% | +3.57% | number_norm=2, llm=1 |
