...
|---|---|---|---|---|
| control | 5 | 29.62% | 29.13% | +0.49% |
| daily | 7 | 28.36% | 27.84% | +0.51% |
...
| 018 | daily | 14.29% | 11.90% | +2.38% | number_norm=3, llm=3 |
...
| 033 | control | 28.97% | 28.62% | +0.34% | car_norm=1, number_norm=11, dict=1, llm=17 |
...
| 044 | control | 34.76% | 31.43% | +3.33% | car_norm=1, number_norm=6, dict=3, llm=7 |
...
| G0068 | door | 21.94% | 20.50% | +1.44% | car_norm=2, number_norm=6, dict=2, llm=6 |
| G0069 | track | 24.29% | 22.86% | +1.43% | dict=2, llm=5 |
