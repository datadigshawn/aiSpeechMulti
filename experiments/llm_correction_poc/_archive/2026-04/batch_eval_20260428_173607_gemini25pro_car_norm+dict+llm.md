...
|---|---|---|---|---|
| control | 19 | 38.08% | 36.83% | +1.25% |
| daily | 26 | 59.64% | 59.32% | +0.32% |
...
| 004 | track | 45.22% | 46.09% | -0.87% | term_blacklist=1, number_norm=6, llm=2 |
...
| 010 | control | 31.75% | 30.16% | +1.59% | number_norm=7, llm=6 |
...
| 014 | track | 43.82% | 43.82% | +0.00% | number_norm=4, llm=2 |
| 015 | daily | 76.32% | 76.32% | +0.00% | llm=1 |
| 016 | daily | 78.95% | 78.95% | +0.00% | — |
| 017 | daily | 56.76% | 56.76% | +0.00% | number_norm=2, llm=2 |
| 018 | daily | 42.86% | 42.86% | +0.00% | number_norm=3, llm=1 |
| 019 | daily | 60.00% | 60.00% | +0.00% | number_norm=2 |
| 020 | daily | 81.25% | 81.25% | +0.00% | — |
| 021 | control | 44.62% | 44.62% | +0.00% | number_norm=2, llm=1 |
| 022 | control | 21.78% | 19.11% | +2.67% | number_norm=6, dict=2, llm=1 |
| 023 | control | 37.60% | 37.60% | +0.00% | number_norm=1, llm=2 |
| 024 | daily | — | — | — | ❌ STT cache not found |
| 025 | daily | 53.12% | 53.12% | +0.00% | number_norm=1, llm=1 |
| 026 | daily | 50.00% | 50.00% | +0.00% | car_norm=1, number_norm=1, llm=1 |
| 027 | control | 8.16% | 7.14% | +1.02% | number_norm=1, llm=1 |
...
| 035 | control | 56.92% | 56.54% | +0.38% | dict=1, llm=2 |
| 036 | track | — | — | — | ❌ STT cache not found |
| 037 | control | 33.50% | 33.25% | +0.26% | car_norm=1, number_norm=1, llm=1 |
| 038 | door | 37.23% | 37.23% | +0.00% | number_norm=3 |
| 039 | control | 56.10% | 56.10% | +0.00% | llm=1 |
| 040 | control | 44.75% | 44.75% | +0.00% | number_norm=1, llm=9 |
| 041 | control | — | — | — | ❌ STT cache not found |
| 042 | control | — | — | — | ❌ STT cache not found |
| 043 | daily | 63.24% | 63.24% | +0.00% | llm=5 |
| 044 | control | 30.95% | 29.52% | +1.43% | car_norm=2, number_norm=4, dict=3 |
| 045 | door | 36.02% | 36.02% | +0.00% | dict=1, llm=1 |
| 046 | control | — | — | — | ❌ STT cache not found |
| 047 | control | 44.44% | 40.67% | +3.77% | car_norm=4, number_norm=17, dict=1, llm=6 |
| 048 | daily | 54.00% | 54.00% | +0.00% | dict=1 |
| 049 | daily | 52.76% | 52.76% | +0.00% | number_norm=1, dict=4 |
| 050 | control | 51.68% | 49.58% | +2.10% | car_norm=4, number_norm=2, llm=3 |
| 051 | daily | 38.89% | 36.11% | +2.78% | car_norm=1 |
| 052 | daily | 54.66% | 54.04% | +0.62% | number_norm=1, llm=1 |
